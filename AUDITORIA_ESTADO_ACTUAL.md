...
| ~~`ZoneCanvas`~~ | **Eliminado 2026-07-25.** Era la versión anterior del canvas panorámico: pegaba fotos de zonas usando `canvas_x_start`/`canvas_x_end` ajustados a mano por zona, en vez del sistema de calibración por puntos que usa `ChainCanvas` hoy. Sin importadores desde antes de borrarse. | — | — |
...
5. ~~`ZoneCanvas` era código muerto~~ — **eliminado el 2026-07-25** (447 líneas, sin ningún importador).
